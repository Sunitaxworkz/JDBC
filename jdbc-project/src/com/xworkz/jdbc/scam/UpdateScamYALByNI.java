...
public class UpdateScamYALByNI {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String updateSql = "update scam_table set s_year=1890, s_amount=25, s_location='Banglore', s_type='Banking' where s_id=11 and s_name='Coal scam'";
